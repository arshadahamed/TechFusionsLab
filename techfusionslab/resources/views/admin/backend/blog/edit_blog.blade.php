        ...
        <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
            <div class="flex-grow-1">
                <h4 class="fs-18 fw-semibold m-0">
                    <i class="fas fa-pen-to-square me-1 text-primary"></i> Edit Blog
                </h4>
            </div>
        </div>
                        ...
                        <form action="{{ route('blogs.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <img id="showAuthorImage"
                                             src="{{ $blog->author_image ? asset('storage/' . $blog->author_image) : url('upload/no_image.jpg') }}"
                            ...
                            <div class="form-check form-switch mb-4">
                                <input type="checkbox" name="is_featured" id="is_featured"
                                       class="form-check-input" {{ $blog->is_featured ? 'checked' : '' }}>
...
$(document).ready(function() {
    ...
    $('#main_image').change(function() { readURL(this, '#showMainImage'); });
    $('#author_image').change(function() { readURL(this, '#showAuthorImage'); });
});
</script>

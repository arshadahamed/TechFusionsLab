                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-md-6 mb-4">
                                            <div class="">
                                                ...
                                                <p>Geetings, fellow software enthusiasts! I'm thrilled to see your intereset
                                                    in exploring my profile. I'm Christian Mayo,
                                                    a 24-year-old software engineer from the United Kingdom. My educational
                                                    path led me to earn a Bachelor's Degeer in Computer Science,
                                                    specializing in Software Engineering. With this qualification, I'm
                                                    equipped to dive into the world of coding and develooment,ready
                                                    to tackle exciting projects and contribute to cutting-edge technological
                                                    advancement...
                                                </p>
                                            </div>
                                            ...
                                            <div class="skills-details mt-3">
                                                ...
                                                <div class="d-flex flex-wrap gap-2">
                                                    <span class="badge bg-light px-3 text-dark py-2 fw-semibold">User
                                                        Interface</span>
                                                    <span class="badge bg-light px-3 text-dark py-2 fw-semibold">User
                                                        Experience</span>
                                                    <span class="badge bg-light px-3 text-dark py-2 fw-semibold">Interaction
                                                        Design </span>
                                                    <span class="badge bg-light px-3 text-dark py-2 fw-semibold">3D
                                                        Design</span>
                                                    <span class="badge bg-light px-3 text-dark py-2 fw-semibold">Information
                                                        Architecture</span>
                                                    <span class="badge bg-light px-3 text-dark py-2 fw-semibold">User
                                                        Research</span>
                                                    <span
                                                        class="badge bg-light px-3 text-dark py-2 fw-semibold">Wireframing</span>
                                                </div>
                                        ...
                                        <div class="col-md-6 col-sm-6 col-md-6 mb-4">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 col-sm-4 col-lg-4">
                                                    <div class="profile-email">
                                                        ...
                                                        <a href="#"
                                                            class="text-primary fs-14 text-decoration-underline">zoyothemes@gmail.com</a>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 col-sm-4 col-lg-4">
                                                    <div class="profile-email">
                                            ...
                                            <div class="skills-details mt-3">
                                                ...
                                                <div class="d-flex flex-wrap gap-2">
                                                    <span
                                                        class="badge bg-light px-3 py-2 text-dark fw-semibold">English</span>
                                                    <span
                                                        class="badge bg-light px-3 py-2 text-dark fw-semibold">Madrian</span>
                                                    <span
                                                        class="badge bg-light px-3 py-2 text-dark fw-semibold">Spanish</span>
                                                    <span
                                                        class="badge bg-light px-3 py-2 text-dark fw-semibold">French</span>
                                                </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            <h4 class="m-0 fw-semibold text-dark fs-16">Website Developing
                                                            </h4>
                                                            <div class="row mt-2 d-flex align-items-center">
                                                                ...
                                                                <div class="col-auto">
                                                                    <a href="#"
                                                                        class="btn btn-sm btn-outline-dark px-3">More
                                                                        Details</a>
                                                                </div>
                                                            </div>
                                                        </div><!--end card-body-->
                                                ...
                                                <div class="col-6">
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            <h4 class="m-0 fw-semibold text-dark fs-16">Algorithm
                                                                Developing</h4>
                                                            <div class="row mt-2 d-flex align-items-center">
                                                                <div class="col">
                                                ...
                                                <div class="col-6">
                                                    <div class="card border mb-0">
                                                        <div class="card-body ">
                                                            <h4 class="m-0 fw-semibold text-dark fs-16">Digital Marketing
                                                            </h4>
                                                            <div class="row mt-2 d-flex align-items-center">
                                                                <div class="col">
                                                ...
                                                <div class="col-6">
                                                    <div class="card border mb-0">
                                                        <div class="card-body">
                                                            <h4 class="m-0 fw-semibold text-dark fs-16">Mobile Developing
                                                            </h4>
                                                            <div class="row mt-2 d-flex align-items-center">
                                                                <div class="col">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-md-6 mb-0">
                                            ...
                                            <div class="row align-items-center g-0">
                                                <div class="col-sm-3">
                                                    <p class="text-truncate mt-1 mb-0"><i
                                                            class="mdi mdi-circle-medium text-primary me-2"></i> Photoshop
                                                    </p>
                                                </div>

                                                <div class="col-sm-9">
                                                    <div class="progress mt-1" style="height: 8px;">
                                                        <div class="progress-bar progress-bar bg-primary rounded"
                                                            role="progressbar" style="width: 72%" aria-valuenow="52"
                                            ...
                                            <div class="row align-items-center g-0 mt-3">
                                                <div class="col-sm-3">
                                                    <p class="text-truncate mt-1 mb-0"><i
                                                            class="mdi mdi-circle-medium text-primary me-2"></i> HTML </p>
                                                </div>
                                                <div class="col-sm-9">
                                                    <div class="progress mt-1" style="height: 8px;">
                                                        <div class="progress-bar progress-bar bg-primary rounded"
                                                            role="progressbar" style="width: 68%" aria-valuenow="48"
                                            ...
                                            <div class="row align-items-center g-0 mt-3">
                                                <div class="col-sm-3">
                                                    <p class="text-truncate mt-1 mb-0"><i
                                                            class="mdi mdi-circle-medium text-primary me-2"></i> CSS </p>
                                                </div>
                                                <div class="col-sm-9">
                                                    <div class="progress mt-1" style="height: 8px;">
                                                        <div class="progress-bar progress-bar bg-primary rounded"
                                            ...
                                            <div class="row align-items-center g-0 mt-3">
                                                <div class="col-sm-3">
                                                    <p class="text-truncate mt-1 mb-0"><i
                                                            class="mdi mdi-circle-medium text-primary me-2"></i> Javascript
                                                    </p>
                                                </div>
                                                <div class="col-sm-9">
                                                    <div class="progress mt-1" style="height: 8px;">
                                            ...
                                            <div class="row align-items-center g-0 mt-3">
                                                <div class="col-sm-3">
                                                    <p class="text-truncate mt-1 mb-0"><i
                                                            class="mdi mdi-circle-medium text-primary me-2"></i> Php </p>
                                                </div>
                                                <div class="col-sm-9">
                                                    <div class="progress mt-1" style="height: 8px;">
                                                        <div class="progress-bar progress-bar bg-primary rounded"
                                                ...
                                                <ol class="profile-section list-unstyled mb-0 px-4">
                                                    <li class="profile-item">
                                                        <div class="avatar-sm profile-icon p-1">
                                                            <div class="avatar-title rounded-2 bg-light"
                                                        ...
                                                        <div class="exper-item-list">
                                                            <div>
                                                                ...
                                                                <div class="list-inline list-inline-dots mb-2 fs-14">
                                                                    ...
                                                                    <div class="list-inline-item list-inline-item-second">2
                                                                        years</div>
                                                                </div>
                                                                <p class="mb-0">Responsible for the product management,
                                                                    product design, research and product partnerships teams
                                                                    at Notion.</p>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li class="profile-item">
                                                        <div class="avatar-sm profile-icon p-1">
                                                            <div class="avatar-title rounded-2 bg-light"
                                                                style="height: 35px; width: 35px;">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                    height="24" viewBox="0 0 256 232">
                                                                    <path fill="#fdb300"
                                                                        d="M128 0L55.855 7.628L0 82.607l128 149.055L256 82.607L200.146 7.628z" />
                                                                    <path fill="#eb6c00"
                                                                        d="m0 82.608l128 149.054L51.846 82.608zm204.153 0L128 231.662L255.999 82.608z" />
                                                                    <path fill="#fdad00"
                                                                        d="M51.846 82.608L128 231.662l76.154-149.054z" />
                                                                    <path fill="#fdd231"
                                                                        d="m55.855 7.628l-4.009 74.979L128 0zm148.298 74.98l-4.008-74.98L128 .001z" />
                                                                    <path fill="#fdad00"
                                                                        d="M204.154 82.608h51.845l-55.854-74.98zM0 82.608h51.846l4.009-74.98z" />
                                                                    <path fill="#feeeb7"
                                                        ...
                                                        <div class="exper-item-list">
                                                            <div>
                                                                ...
                                                                <p class="mb-0">Lead and grew the sketch product
                                                                    management team. Managed teams across Menio Park,
                                                                    Denver, New York and Remote offices.</p>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li class="profile-item pb-0">
                                                        ...
                                                        <div class="exper-item-list">
                                                            ...
                                                            <div class="list-inline list-inline-dots mb-2 fs-14">
                                                                ...
                                                                <div class="list-inline-item list-inline-item-second">3
                                                                    years</div>
                                                            </div>
                                                            <p class="mb-0">Director and grew the mailchimp product
                                                                management team. Managed teams across Menio Park, Denver,
                                                                New York and Remote offices.</p>
                                                        </div>
                                                    </li>
                                                </ol>
                                            </div>
                                                ...
                                                <ol class="profile-section list-unstyled mb-0 px-4">
                                                    <li class="profile-item">
                                                        ...
                                                        <div class="exper-item-list">
                                                            ...
                                                            <p class="mb-0">Underlook 6 dynamic projects withing just 8
                                                                months, showcasing my versatility and proactiveapprocach.
                                                                Notable accomplishments include Designed.</p>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li class="profile-item">
                                                        ...
                                                        <div class="exper-item-list">
                                                            <h5 class="font-size-16 mb-1">Mobile Developer & Algo Expert
                                                            </h5>
                                                            <div class="list-inline list-inline-dots mb-1 fs-14">
                                                            ...
                                                            <div class="list-inline list-inline-dots mb-2 fs-14">
                                                                ...
                                                                <div class="list-inline-item list-inline-item-second">1
                                                                    years</div>
                                                            </div>
                                                            <p class="mb-0">Underlook 6 dynamic projects withing just 8
                                                                months, showcasing my versatility and proactiveapprocach.
                                                    ...
                                                    <li class="profile-item pb-0">
                                                        ...
                                                        <div class="exper-item-list">
                                                            ...
                                                            <p class="mb-0">Underlook 6 dynamic projects withing just 1
                                                                months, showcasing my versatility and proactiveapprocach.
                                                                Notable accomplishments include:- Designed.</p>
                                                        </div>
                                                    </li>
                                                ...
                                                <ol class="profile-section list-unstyled mb-0 px-4">
                                                    <li class="profile-item">
                                                        ...
                                                        <div class="exper-item-list">
                                                            ...
                                                            <p class="mb-2 fw-semibold text-dark">Bachelor Degree In
                                                                Computer Science and Mathematies</p>
                                                            <div class="list-inline list-inline-dots mb-2 fs-14">
                                                            ...
                                                            <div class="avatar-title rounded-2 bg-light"
                                                                ...
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="30"
                                                                    ...
                                                                    <g mask="url(#circleFlagsUnitedNations0)">
                                                                        ...
                                                                        <path fill="#eee"
                                                                            d="m304 193.7l14.2 14.2l-110.3 110.3l-14.2-14.1z" />
                                                                        <path fill="#eee"
                                                                            d="m318.2 304l-14.1 14.2l-110.4-110.3l14.2-14.2z" />
                                                                        <circle cx="256" cy="256" r="44"
                                                                            fill="#eee" />
                                                                        <circle cx="256" cy="256" r="22"
                                                                            fill="#338af3" />
                                                                        <ellipse cx="256" cy="412"
                                                                            fill="#eee" rx="44"
                                                                            ry="40" />

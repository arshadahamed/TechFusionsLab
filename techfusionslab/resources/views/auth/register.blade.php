                                    ...
                                    <div class="pt-0">
                                        <form method="POST" action="{{ route('register') }}" class="my-4">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input class="form-control" type="password" required="" id="password_confirmation" name="password_confirmation" placeholder="Enter your confirm password">
                                            </div>
                    ...
                    <div class="col-xl-7">
                        <div class="account-page-bg p-md-5 p-4">
                            <div class="text-center">
                                <h3 class="text-dark mb-3 pera-title">Quick, Effective, and Productive With Pluto Consultancy Admin Dashboard</h3>

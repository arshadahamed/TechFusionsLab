    ...
    <div class="container-fluid">
        ...
        <div class="col-xl-3 col-lg-3">
            <div class="gt-shape-image">
                <img src="{{ asset('frontend/assets/img/home-1/hero/map.png') }}" alt="img">
            </div>
        </div>
        <div class="col-xl-4 col-lg-4">
            <div class="gt-hero-image wow img-custom-anim-bottom" data-wow-duration="1.3s" data-wow-delay="0.3s">
                <img src="{{ asset('frontend/assets/img/home-1/hero/hero-1.jpg') }}" alt="img">
            </div>
        </div>
        <div class="col-xl-5 col-lg-5">
            <div class="right-content wow img-custom-anim-right" data-wow-duration="1.3s" data-wow-delay="0.3s">
                <p>
                    Based in Harrow, London, Modern Trading and Services LLP provides tailored financial and business solutions for SMEs, delivering expert guidance and trusted support to help your business grow with confidence.                </p>

        ...
        <div class="gt-team-wrapper">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="gt-team-card-items">
                        <div class="gt-team-image">
                            <img src="{{ asset('frontend/assets/img/home-1/team/04.jpg') }}" alt="img">
                            <div class="gt-team-content">
                                <h4>
                                    <a href="team-details.html">Pelican Steve</a>
                                </h4>
                                <p>SR. Consultant</p>
                            </div>
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="gt-team-card-items">
                        <div class="gt-team-image">
                            <img src="{{ asset('frontend/assets/img/home-1/team/05.jpg') }}" alt="img">
                            <div class="gt-team-content">
                                <h4>
                                    <a href="team-details.html">Pelican Steve</a>
                                </h4>
                ...
                <div class="swiper-slide">
                    <div class="gt-team-card-items">
                        <div class="gt-team-image">
                            <img src="{{ asset('frontend/assets/img/home-1/team/06.jpg') }}" alt="img">
                            <div class="gt-team-content">
                                <h4>
                                    <a href="team-details.html">Pelican Steve</a>
                                </h4>

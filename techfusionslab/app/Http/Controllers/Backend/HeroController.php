...
class HeroController extends Controller
{
    ...
    public function updateHero(Request $request, $id)
    {
        ...
        // Handle image uploads -> store in storage/app/public/upload/hero
        if ($request->hasFile('main_image')) {
            if ($hero->main_image && Storage::disk('public')->exists($hero->main_image)) {
                Storage::disk('public')->delete($hero->main_image);
            }
            $data['main_image'] = $request->file('main_image')->store('upload/hero', 'public');
        }
        ...
        if ($request->hasFile('bg_image')) {
            ...
            $data['bg_image'] = $request->file('bg_image')->store('upload/hero', 'public');
        }
        ...
        if ($request->hasFile('map_image')) {
            ...
            $data['map_image'] = $request->file('map_image')->store('upload/hero', 'public');
        }
